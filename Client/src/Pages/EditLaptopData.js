...
import { EditLaptop , getLaptopPhone} from '../Service/LaptopApi';


import '../CSS/AddPhoneData.css'

const EditLaptopData = () => {
    ...
    useEffect(() =>{
        ...
        const loadLaptopDetail = async() =>{
            const resp = await getLaptopPhone(id);
            // console.log(resp.data , "eyre")
            setlaptopUsers(resp.data)
        }


    const EditLaptopData = async() => {

        console.log("laptop",laptopUsers)
        ...
        if (!laptopUsers.laptopName.match(/^.{6,}$/)) {
            ...
            await EditLaptop(laptopUsers, id)
                ...
                <div className="row d-flex align-items-center justify-content-center">
                    ...
                    <div className="row mb-2  mb-4">
                        ...
                        <div className="col-12  d-flex align-items-center justify-content-center">
                            ...
                            <button className='loginSytemBtn mx-3 my-4' onClick={EditLaptopData}>Add Data</button>
